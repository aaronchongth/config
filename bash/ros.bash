...
alias cbrel="colcon build --mixin release lld"
...
alias cbdeb="colcon build --cmake-args -DCMAKE_BUILD_TYPE=Debug"
alias cbmideb="colcon build --merge-install --cmake-args -DCMAKE_BUILD_TYPE=Debug"
alias cbdebpu="cbdeb --packages-up-to"
alias cbdebps="cbdeb --packages-select"
